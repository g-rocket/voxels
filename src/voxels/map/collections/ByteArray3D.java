...
public class ByteArray3D 
{
    ...
    private static int LogBase2(int n) { // assumes positive integer power of two
    	...
    	throw new IllegalArgumentException("i is not a positive integer power of two");
         // calculate the LogBase2 of n (power of 2 that gets you n)
         // all n (sizes) must be an integer power of 2!!
         // this may seem pointless, since we know that 
         // the size is 16 in all cases (so the answer is 4)
         // but having this method is nice in case we ever decide to
         // change chunk dimensions.
         // you'll need to know these logs later.
    }
